    ...
    <div class="createMembership">
        <div class="membershipChoice">
            ...
            <b-card-group deck class="cardDeck">
                    ...
                    <b-card v-for="card in cards" :key="card.id"
            ...
            <p><b>Hva er AvtaleGiro?</b> Banken betaler regningen for deg, uten at du trenger å godkjenne først. 
                Du slipper å huske på forfallsdatoer og unngår fakturagebyr. 
                Vi trekker den første hver måned.</p>
        </div>
    ...
    methods: {
        ...
        createCardsFromContract() {
            ...
            this.contractsByInst.forEach(element => {
                ...
                var card = new MembershipCard(element.id, lockInText, fee, infoText, label);
